...
def tick_check(category, task_data):
    ...
    for i in task_data["advancements"]:
        ...
        fstr += "execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..5] if predicate world_boarder_shrine:advancements/"+i.replace(':','/',1)+" run scoreboard players set temp0 wbs.reg 1\n"
