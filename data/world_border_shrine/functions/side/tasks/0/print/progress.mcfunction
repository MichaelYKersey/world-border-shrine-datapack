...
execute if score side.0.treasure wbs.item_drain matches 1.. run tellraw @s ["\u2022",{"score":{"name":"side.0.treasure","objective":"wbs.item_drain"},"color":"#00cc44"},{"text":"-treasure (saddle, name tag, or nautilus shell)","color":"#00cc44"}]
...
execute if score side.0.tropical_fish wbs.item_drain matches 1.. run tellraw @s ["\u2022",{"score":{"name":"side.0.tropical_fish","objective":"wbs.item_drain"},"color":"#00cc44"},{"text":"-tropical fish","color":"#00cc44"}]
