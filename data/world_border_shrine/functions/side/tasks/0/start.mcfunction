...
function world_border_shrine:side/list/manager/add_public {item:0}

#call the tick
function world_border_shrine:side/tasks/0/tick

#call start print sequence
function world_border_shrine:side/tasks/0/print/start/0
