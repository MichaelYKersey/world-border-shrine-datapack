...
execute if score main.2.blast_furnace wbs.item_drain matches 1.. run tellraw @s ["\u2022",{"score":{"name":"main.2.blast_furnace","objective":"wbs.item_drain"},"color":"#00cc44"},{"text":"-blast furnace","color":"#00cc44"}]
