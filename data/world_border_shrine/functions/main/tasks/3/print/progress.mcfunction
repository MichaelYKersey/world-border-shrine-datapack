...
execute if score main.3.grass wbs.item_drain matches 1.. run tellraw @s ["\u2022",{"score":{"name":"main.3.grass","objective":"wbs.item_drain"},"color":"#00cc44"},{"text":"-grass (not a grass block)","color":"#00cc44"}]
execute if score main.3.leaf_blocks wbs.item_drain matches 1.. run tellraw @s ["\u2022",{"score":{"name":"main.3.leaf_blocks","objective":"wbs.item_drain"},"color":"#00cc44"},{"text":"-leaf blocks","color":"#00cc44"}]
