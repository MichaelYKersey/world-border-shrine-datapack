...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s {"text":"It seems that what you see in the water and what you can fish out if it are different, bring me samples of what you can pull out of nearby water with a fishing rod","color":"#9933ff"}
#print details
