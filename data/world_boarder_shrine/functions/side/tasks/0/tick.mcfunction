#refresh ticking
schedule function world_boarder_shrine:side/tasks/0/tick 1t replace
#update item channels
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @e[distance=..3,type=minecraft:item] run function world_boarder_shrine:side/tasks/0/item_drain
...
function world_boarder_shrine:side/tasks/0/end