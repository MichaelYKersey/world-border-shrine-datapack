...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s {"text":"Let us take inspiration from the late Google, and make some maps! that will get enough data for weather manipulation.","color":"#9933ff"}
#print details
