...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s {"text":"I have been sensing some weird side effects from the fog. There are lots of green glowing orbs that seem to be absorbing into you.","color":"#9933ff"}
