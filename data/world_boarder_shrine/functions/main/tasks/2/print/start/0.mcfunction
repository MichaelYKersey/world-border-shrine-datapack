...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s I'm running low on reserve power. Could you bring me some fuel.
#print details
