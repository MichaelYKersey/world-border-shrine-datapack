#refresh ticking
schedule function world_border_shrine:main/tasks/4/tick 1t replace
#update item channels
execute as @e[type=minecraft:interaction,tag=world_border_shrine] at @s as @e[distance=..3,type=minecraft:item] run function world_border_shrine:main/tasks/4/item_drain
...
function world_border_shrine:main/tasks/4/end