...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s {"text":"I need higher grade materials to upgrade my processing speed.","color":"#9933ff"}
#print details
