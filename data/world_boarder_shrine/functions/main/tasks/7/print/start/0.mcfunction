...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s To gain a better sense of community, I ask you all to build a center to commune with each other.
#print details
