...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s {"text":"Interesting, a stable portal! The magic of this place is so intriguing. I'll process these data samples asap.","color":"#9933ff"}
