...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run tellraw @s {"text":"Ok, this area should be secure from the fog but to expand our working area is going to take time and data.","color":"#9933ff"}
