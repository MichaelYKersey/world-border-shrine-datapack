...
execute unless score printing wbs.vars matches 0 run return run schedule function world_boarder_shrine:main/templates/item_drain/print/start/0 1t replace
...
execute as @e[type=minecraft:interaction,tag=world_boarder_shrine] at @s as @a[distance=..10] run funciton world_boarder_shrine:main/templates/item_sacrafice/print/details
