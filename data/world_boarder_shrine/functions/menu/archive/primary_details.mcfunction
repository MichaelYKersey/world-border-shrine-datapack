scoreboard players enable @s wbs.primary_archive.details
scoreboard players operation temp0 wbs.reg = @s wbs.primary_archive.details
run scoreboard players reset @s wbs.primary_archive.details
