...
tellraw @s {"text":"2.current main task progress","clickEvent":{"action":"run_command","value":"/trigger wbs.menu set 2"}}
tellraw @s {"text":"3.current main task details","clickEvent":{"action":"run_command","value":"/trigger wbs.menu set 3"}}
tellraw @s {"text":"4.current main task progress start message","clickEvent":{"action":"run_command","value":"/trigger wbs.menu set 4"}}
tellraw @s {"text":"5.previous main task end message","clickEvent":{"action":"run_command","value":"/trigger wbs.menu set 5"}}
...
tellraw @s {"text":"12.main tasks archive","clickEvent":{"action":"run_command","value":"/trigger wbs.menu set 12"}}