...
$execute if score temp0 wbs.reg matches ..0 run return run function world_boarder_shrine:item_drain/feed_normal {channel:$(channel)}
#else overflow case
$function world_boarder_shrine:item_drain/feed_overflow {channel:$(channel)}